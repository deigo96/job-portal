        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <a href="<?php echo base_url('admin/allUsers'); ?>" class="">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      ...
                      <li>
                        <img src="<?php echo base_url('assets/images/profile_pictures/'. $user->images); ?>" alt="User Image" style="width:50%;height:50%;">
