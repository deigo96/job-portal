                ...
                <div class="row pt-2">
                    <div class="col-md-6 offset-3">
                        ...
                        <?php echo form_open_multipart('admin/addModel', '', '') ?>
                            ...
                            <div class="form-group">
                                <?php echo form_textarea('md', '', array('placeholder' => 'Enter Model Descriptions', 'class' => 'form-control')) ?>
                            </div>
                            <div class="form-group">
                                <input type="number" name="price" min="0" step="0.01" id="price" placeholder="0.00" class="form-control" value="<?= set_value('price') ?>">
                            </div>
                            <div class="form-group">
                                <?php
                                    ...
                                    echo form_dropdown('productId', $categoriesOptions, '', 'class="form-control"');
                                ?>            
                            </div>
                            <div class="form-group">
          ...
          <div class="card card-primary">
            ...
            <?php echo form_open_multipart('admin/addModel', '', '') ?>
              ...
              <div class="form-group">
                ...
                <?php echo form_upload('modelDp', '','form-control custom-file'); ?>
              </div>
